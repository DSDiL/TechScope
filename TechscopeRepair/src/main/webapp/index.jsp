...
<section class="text-center">
  ...
  <nav class="navbar navbar-expand-md py-4 navbar-dark red  sticky-top  ">
      ...
      <div class="container mt-5">
              ...
              <div class="col-md-8 ">
                  <div id="car" class="carousel slide" data-ride="carousel">
                      ...
                      <div class="carousel-inner ">
                          <div class="carousel-item active"><img class="w-100 d-block rounded "src="images/slide1.jpg"></div>
                          <div class="carousel-item"><img class="w-100 d-block rounded" src="images/computer4.jpg"></div>
                          <div class="carousel-item"><img class="w-100 d-block rounded" src="images/other1.jpg"></div>
                      </div>
                  </div>
              </div>
        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-md-4  text-center" style="color:#fff;">
                    <div class="h2 text-uppercase"style="border:3px solid; border-radius: 20px; padding:5px;">Our Mission</div>
                    <p data-aos="fade-right" data-aos-duration="1000" style="font-family: 'Montserrat', sans-serif;border:1px solid; border-radius: 25px; padding:5px; ">We are JC-Electronics, a purchasing and sales organization trading in industrial electronics on a global level. Our services include providing items for use in production processes and other automated environments. In the world of industrial automation, new technologies are rolled out in quick succession, resulting in a reduction in service and availability of existing technologies. This is where JC-Electronics comes into play. If it has worked before, it can certainly work again! There is no need to buy something new, when you already have something reliable that does the trick! Which is why we offer knowledge, expertise and continuity, We do this through purchase, sale, repair, testing and many more high-quality services.
                    </p>
                </div>
                <div class="col-md-8 ">
                    <div id="car" class="carousel slide" data-ride="carousel">
        ...
        <hr class="mt-5 mb-5">
          ...
          <div class="container mt-5 " >
            <div class="h1 text-uppercase text-center mt-5"style="border:2px solid #fff; color: #fff;border-radius: 15px; padding:5px;">Our services</div>
              <div class="row text-center text-white" >
                <div class="card-deck">


                  <div class="card p-3 mx-5 "data-aos="fade-left" data-aos-duration="700" style="width:18rem; box-shadow: -30px 30px 20px rgba(0,0,0,0.6);">
                    <img src="images/computer5.jpg" alt="image" class="card-img-top shadow bg-white rounded">
                    <div class="card-body">
                     <h5 class="card-title">Card title</h5>
                      <p class="card-text">sadf dsfsd dfsdf df df sdf  dsf  sdf   sdf  fieldset</p>
                    </div>
                      <div class="card-footer bg-transparent text-center ">
                          <button type="button" class="mybuttonoverlap btn btn-info "><i class="bi bi-pc-display"></i>Read More</button>
                      </div>
                  </div>


                  <div class="card p-3 mx-5" data-aos="fade-up" data-aos-duration="700" style="width:18rem;box-shadow: -30px 30px 20px rgba(0,0,0,0.6);">
                    <img src="images/ac1.jpg" alt="image" class="card-img-top shadow bg-white rounded">
                    <div class="card-body">
                      <h5>Air Conditioner</h5>
                      <p class="card-text">sadf dsfsd dfsdf df df sdf  dsf  sdf   sdf  fieldset</p>
                    </div>
                    <div class="card-footer bg-transparent text-center ">
                        <button type="button" class="mybuttonoverlap btn btn-info "> <i class="bi bi-wind"></i>Read More</button>
                    </div>
                  </div>



                  <div class="card p-3 mx-5" data-aos="fade-right" data-aos-duration="700" style="width:18rem; box-shadow: -30px 30px 20px rgba(0,0,0,0.6);">
                    <img src="images/other2.jpg" alt="image" class="card-img-top shadow bg-white rounded">
                    <div class="card-body">
                      <h5>Air Conditioner</h5>
                      <p class="card-text">sadf dsfsd dfsdf df df sdf  dsf  sdf   sdf  fieldset</p>
                    </div>
                    <div class="card-footer bg-transparent text-center ">
                        <button type="button" class="mybuttonoverlap btn btn-info "><i class="bi bi-tools"></i>Read More</button>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <script>
    var words = ['Welcome to TECHSCOPE', 'Fix Your Desktops', 'Fix Your Laptops', ' Fix Your Air Conditioners', 'And Many More Electronics'],
  part,
  i = 0,
  offset = 0,
  len = words.length,
