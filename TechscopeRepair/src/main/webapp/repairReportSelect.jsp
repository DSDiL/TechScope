...
<body>
	...
	<form class="text-center" action="repairReport" method="post">
	
	<div class="form mx-auto">
	
		<h2 class="text-center text-white"> <b>Monthly Repair Reports</b></h2><br><br>	
	
	  <div class="form-group row">
		  <label for="" class="col-sm-2 col-form-label">Repair Type</label>
		  <div class="col-sm-10">
			<select name="type" id="" class="form-control" required>
			  <option selected="selected">---Select---</option>
				<option value="ongoing">Ongoing Repairs</option>
