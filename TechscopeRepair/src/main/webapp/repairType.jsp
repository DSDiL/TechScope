		...
		<tr>
			...
			<td>
				<c:if test="${type=='Air Conditioners'}">
					...
					<a href="${appAir}">
						<input type="button" value="Add New Repair"class="btn btn-info">
					</a>
				</c:if>
			...
			<td>
				<form action="appointmentRemove" method="post">
					<button type="submit" class="btn btn-danger" name="submit" onclick="check()" value="${appointment.appID}">Remove</button>
				</form>
			</td>
		</tr>
		</c:forEach>
